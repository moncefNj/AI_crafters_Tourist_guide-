...
The current code follows the same documentation as the Twilio Speech Assistant (shown below). 

The modifications added are on the main.py file (context and adaptation of the code to our proposed scenario).

The added folder "Client twilio" contains the code for the client side, with the static domain url used with ngrok.

The port used for the server and the call is 5050.

The requirements and all ther configuration is, as mentionned, similar to the Twilio documentation.

Please, to test the code, make sure to add your own sid and token in the client.py as well as the openai key in the main.py
